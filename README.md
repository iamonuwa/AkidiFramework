Akidi is an MVC Framework developed on PHP 5.4 MVC system. It's designed to be simple and modular, allowing developers to build better and easy to maintain code with PHP.
